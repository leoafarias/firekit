 ...
 * Provides filtering, sorting, and limiting capabilities for in-memory data.
 */
export class InMemoryQueryBuilder<T> implements IQueryBuilder<T> {
  ...
  /**
   * Creates an in-memory query builder instance.
   * @param dataSource - Function that returns the current data source array
   */
  constructor(private readonly dataSource: () => T[]) {}
